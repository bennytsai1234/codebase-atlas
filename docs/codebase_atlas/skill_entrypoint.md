...
- `SKILL.md` 是 Codebase Atlas 的主要 skill 入口，包含 front matter、使用時機、初始化前簡報、初始決策、核心流程與後續 Atlas 使用規則。
...
- 代理人解析或詢問輸出語言、Atlas 模式、交付政策與 reference-assisted feature parity。
